...
Execute unit tests
```
    cd "WeatherSqsConsumerLambdaFunction/test/WeatherSqsConsumerLambdaFunction.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "WeatherSqsConsumerLambdaFunction/src/WeatherSqsConsumerLambdaFunction"
